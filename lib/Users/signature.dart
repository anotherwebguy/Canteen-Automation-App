...
class _SignState extends State<Sign> {
  ...
  Future<void> Save() async{
    await FirebaseFirestore.instance.collection('History')
      ...
      //await FirebaseFirestore.instance.collection('kitchen').doc(widget.id).delete();
      setState(() {
        isLoading = false;
      });
 ...
 Future<void> loadDialog() async {
  ...
  Widget getAppBar(context, String title, {color = const Color(0XFF8998FF), textColor: Colors.white, List<Widget> actions}) {
    return AppBar(
      actions: actions,
